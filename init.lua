...
cmp.setup {
  ...
  mapping = cmp.mapping.preset.insert {
    ...
    -- Need the <Tab> for co pilot and already used to the defaults
    -- so canceling this for now
    -----------------------------
...
vim.keymap.set('n','<C-e>',ui.toggle_quick_menu, {desc = "Toggle the UI for harpoon"})

vim.keymap.set('n','<C-h>',function() ui.nav_file(1) end, {desc = "Navigate to 1st file in harpoon"})
vim.keymap.set('n','<C-t>',function() ui.nav_file(2) end,{desc = "Navigate to 2nd file in harpoon"})
vim.keymap.set('n','<C-n>',function() ui.nav_file(3) end,{desc = "Navigate to 3rd file in harpoon"})
vim.keymap.set('n','<C-d>',function() ui.nav_file(4) end, {desc = "Navigate to 4th file in harpoon"})
...
-- setting up lua line as transparent
--
...
local null_ls_attach = function(client, buffer)
...
local file_types = {
  ...
  "typescriptreact", "javascriptreact", "handlebars"
}
null_ls.setup({
  sources = {
